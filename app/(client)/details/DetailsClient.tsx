    ...
    <div className="max-w-7xl mx-auto px-4 py-16">
      ...
      <div className="mb-12 max-w-4xl">
        ...
        <p className="text-gray-600">
          Every detail of how your Freepoint Home is built.
        </p>
      </div>
      ...
      <div className="text-center mt-16">
        <p className="text-gray-600 mb-6">
          Ready to customize your home?
        </p>
        <a href="/customizations">
          <button className="bg-[#C2A45C] hover:bg-[#C2A45C]/80 transition text-white px-10 py-4 rounded-md font-semibold">
            Customize Your Home
          </button>
        </a>
      </div>
