...
function Navbar() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("nav", {
        className: "fixed top-0 left-0 right-0 flex items-center justify-between h-16 w-full bg-white z-50 transition-all duration-500 ease-in-out ".concat(isScrolled ? 'shadow-lg' : '', " ").concat(isVisible ? 'translate-y-0 opacity-100' : '-translate-y-full opacity-0'),
        children: [
